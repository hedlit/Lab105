...
\begin{document}
  ...
  All tests pass. Parse takes about 16 seconds and the algorithm takes 1 or 1.5 seconds.
  ...
  Implemented simple line and circle classes, circles stored in array and lines in priorityqueue. Arrays created a readable combine/union, while priorityqueue was preferable as poll() O(1) can be used.
  O(mlogm).
\end{document}
